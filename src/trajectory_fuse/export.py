...
<head>
<meta charset="utf-8"/>
<title>trajectory-fuse trajectory</title>
<style>
...
<body>
<h1>trajectory-fuse trajectory</h1>
<p class="meta">
  run_id <code>{run_id}</code> · {count} record{suffix} · generated by trajectory-fuse {version}
</p>
<div class="legend">
